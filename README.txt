...
Lab7.sln - The Visual Studios solution.
...
Simple_Reduce.exe - The reference .exe file. Do not submit it.

Folders:

Dataset - Contains the tests.
Reduce - Contains the Visual Studios project and source code for Reduce.
Simple_Reduce - Contains the Visual Studios project and source code for the Simple Reduce.
